...
// Hands and feet are tiny (low moment of inertia); an angle constraint on them
// jitters/spins endlessly. They get free (point-only) joints and just dangle.
const FREE_LEAF_BONES: [&str; 4] = ["hand.l", "hand.r", "foot.l", "foot.r"];
